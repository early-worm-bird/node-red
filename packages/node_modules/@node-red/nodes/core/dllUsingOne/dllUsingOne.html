<script type="text/javascript">
    RED.nodes.registerType('dllUsingOne', {
        category: 'dll',
        color: '#FDD0A2',
        defaults: {
            name: { value: "" },
...
<script type="text/x-red" data-template-name="dllUsingOne">
    <div class="form-row">
        <label for="node-input-name"><i class="icon-tag"></i> Name</label>
        <input type="text" id="node-input-name" placeholder="Name">
    </div>
    <div class="form-row">
        <label for="node-input-references"><i class="icon-tag"></i> Assembly references</label>
    </div>
    <div>
        <textarea style="width: 100%; resize: vertical; min-height: 6em;" id="node-input-references"></textarea>
    </div>
...
<script type="text/x-red" data-help-name="dllUsingOne">
