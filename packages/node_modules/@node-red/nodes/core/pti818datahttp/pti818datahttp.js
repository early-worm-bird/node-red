module.exports = function (RED) {
    function pti818datahttpNode(config) {
            ...
            try {
                ...
                if (text == "Barcode") {
                    ...
                    const reservedKeys = ["Event", "DateTime", "User", "FileName", "BoardName", 
                                        "BoardBarcode", "StartType", "IctFile", "BoardCount",
    ...
    RED.nodes.registerType("pti818datahttp", pti818datahttpNode);
}
