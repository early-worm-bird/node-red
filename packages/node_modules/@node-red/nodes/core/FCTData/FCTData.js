module.exports = function (RED) {
                ...
                if (text == "Barcode") {
                    ...
                    lines.forEach(line => {
                        ...
                        if (key.startsWith('_')) {
                            ...
                            const boardIndex = parseInt(match[1], 10) - 1;
                            if (!boards[boardIndex]) {
                                boards[boardIndex] = { ID: "B" + (boardIndex + 1), Barcode: '', Pass: 0, data: {} };
                            }
                            if (key == "B" + (boardIndex + 1) + ".Barcode") {
                            ...
                            if (index == Object.keys(newDetail).length) {
                                ...
                                if (csvAll.length > 0) {
                                    ...
                                    resultLines.forEach(line => {
                                        ...
                                        if (values[0] == "FunctionTest") {
                                            datas.FunctionTest = values[1];
                                        }
                                        ...
                                        if (values[0] == "LogEnd") {
                                            ...
                                            //node.log(boards);
                                            boards.forEach(one => {
                                                node.log("one.ID"+one.ID+"datas.BoardId"+datas.BoardId)
                                        ...
                                        if (compTestFlag == 1 && compTestFlagStart == 1 && values[0] != null && values[0] != ""&&values[0] !="FunTest:") {
                                            let stepCompData = {
                                                STEP: values[0],
                                                BX: values[1],
                                                LC: values[2],
    ...
    RED.nodes.registerType("FCTData", FCTDataNode);
}
